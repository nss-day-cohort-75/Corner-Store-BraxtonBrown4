...
public class CornerStoreDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderProduct>().HasData(
            ...
            new OrderProduct { Id = 7, OrderId = 4, ProductId = 7 },
            new OrderProduct { Id = 8, OrderId = 4, ProductId = 8 },
            new OrderProduct { Id = 9, OrderId = 5, ProductId = 9 },
            new OrderProduct { Id = 10, OrderId = 5, ProductId = 10 },
            new OrderProduct { Id = 11, OrderId = 6, ProductId = 1 },
            new OrderProduct { Id = 12, OrderId = 6, ProductId = 3 },
            new OrderProduct { Id = 13, OrderId = 7, ProductId = 5 },
            new OrderProduct { Id = 14, OrderId = 7, ProductId = 7 },
            new OrderProduct { Id = 15, OrderId = 8, ProductId = 9 },
            new OrderProduct { Id = 16, OrderId = 8, ProductId = 2 },
            new OrderProduct { Id = 17, OrderId = 9, ProductId = 4 },
            new OrderProduct { Id = 18, OrderId = 9, ProductId = 6 },
            new OrderProduct { Id = 19, OrderId = 10, ProductId = 8 },
            new OrderProduct { Id = 20, OrderId = 10, ProductId = 10 },
            new OrderProduct { Id = 21, OrderId = 11, ProductId = 2 },
